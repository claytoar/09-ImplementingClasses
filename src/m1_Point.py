...
class Point(object):
    # objects are a point with an x and y coordinate
    ...
    def move_by(self, dx, dy):
        ...
        self.x = self.x + dx
        self.y = self.y + dy
        self.moves_by = self.moves_by + 1


    def get_number_of_moves_made(self):
        self.moves = self.moves_to + self.moves_by
        return self.moves
    ...
    def get_distance_from_start(self):
        ...
        distance = self.get_distance_from(p0)
        return distance
